...
export const DUMMYPOST_2 = `
  <article>
    <p>The year 1983 marked a critical juncture in the history of video games, one that came to be known as the Video Game Crash of 1983. What began as a seemingly unstoppable rise of the video game industry in the late 1970s and early 1980s suddenly came crashing down, leaving both gamers and the industry in a state of turmoil. In this article, we will explore the factors that led to the crash, its widespread consequences, and how the gaming industry eventually rose from the ashes to become the global behemoth it is today.
    </p>
    
    <div>
       <img src="https://i.pcmag.com/imagery/articles/03WPbhb0xYiMWhqw7j48tRJ-20..v1656335263.jpg">
    </div>
    
    <div>
    <h3>The Rise of Home Video Gaming</h3>

    <p>During the late 1970s and early 1980s, the video game industry experienced an unprecedented surge in popularity. The introduction of home gaming consoles such as the Atari 2600, along with arcade machines like Pac-Man and Space Invaders, had gamers and developers alike excited about the endless possibilities of the medium.</p>
    
    <p>At the height of its success, the industry was generating billions of dollars in revenue, and household names like Atari, Namco, and Nintendo emerged as industry leaders. It seemed that the sky was the limit for video games.</p>
    </div>
  </article>
`
